...
A3EAIC_radioMessage2 = "[RADIO] %1: Target looks like a convict. Find them!"; //%1: AI leader name, %2: Target player type
...
A3EAIC_radioMessage5 = "[RADIO] %1: Target has been eliminated.  Notify the warden we've got another one down."; //%1: AI leader name
...
A3EAIC_radioMessage12 = "[RADIO] %1: Target is a convict! Stay on alert!"; //%1: AI leader name, %2: Target player type
...
A3EAIC_radioMessage15 = "[RADIO] %1: The target has been killed.  Better call the warden."; //%1: AI leader name
